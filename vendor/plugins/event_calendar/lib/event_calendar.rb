module EventCalendar
  ...
  module ClassMethods
    ...
    def events_for_date_range(start_d, end_d, find_options = {})
      self.where(:start_at.gt => start_d.to_time.utc, :end_at.lt => end_d.to_time.utc).asc(:start_at)
      # self.where(:start_at.lt => start_d.to_time.utc, :end_at.gt => end_d.to_time.utc).asc(:start_at).documents
      # debugger
      # puts "end"
